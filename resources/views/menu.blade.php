                        ...
                        <ul class="dropdown-menu dropend dropdown-menu-dark">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropend dropdown-menu-dark">
                                    ...
                                    <li><a class="dropdown-item text-secondary" href="#">Import Reports
                                            Documents</a>
                                    </li>
                                    <li><a class="dropdown-item text-secondary" href="#">Import
                                            Reports/Profiles</a>
                                    </li>
                                    <li><a class="dropdown-item text-secondary" href="#">Import Reports
                                            updates</a>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropend dropdown-menu-dark">
                                    ...
                                    <li><a class="dropdown-item text-secondary" href="#">Surveys Templates</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropend dropdown-menu-dark">
                                    <li><a class="dropdown-item text-secondary" href="#">Premises Fields</a>
                                    </li>
                                    <li><a class="dropdown-item text-secondary" href="#">Profiles Fields</a>
                                    </li>
